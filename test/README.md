...
| `undated-entries.test.mjs` | The undated sentinel round-trips: blank in, `1900-01-01` stored, blank rendered; sentinel is in the past so undated entries sink and sort alphabetically |
