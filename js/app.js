...
document.addEventListener('click', (e) => {
  const a = e.target.closest('.md-view a[href^="#"]');
  if (!a) return;
...
document.addEventListener('click', (e) => {
  ...
  // In-page anchors (raw href starts with "#") are handled above — skip them.
  // Their resolved .href inherits the current ?search= query, which would
  // otherwise trip the has('search') check below and reload the feed view.
